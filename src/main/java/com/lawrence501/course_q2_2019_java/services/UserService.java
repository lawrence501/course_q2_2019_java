...
import com.lawrence501.course_q2_2019_java.exceptions.DuplicateEmailException;
...
public class UserService {
  ...
  public User saveUser(User newUser) {
    try {
      ...
      throw new DuplicateEmailException("Username '" + newUser.getUsername() + "' already exists");
    }
  }
}